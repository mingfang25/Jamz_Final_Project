...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final String GoogleTAG = "GoogleLogin";

    private static final int FB_RC_SIGN_IN = 123;
...
// Initialize Firebase Auth
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // Result returned from launching the Intent from GoogleSignInClient.getSignInIntent(...) and FB sign in;
