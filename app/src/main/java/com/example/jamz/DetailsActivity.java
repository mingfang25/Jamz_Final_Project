...
import com.example.jamz.adapters.CommentAdapter;
import com.example.jamz.models.YoutubeCommentModel;
...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private static String GOOGLE_YOUTUBE_API = "AIzaSyBEjPfwZEYB3XHyglA3fdRML_HbhPt-q3g";
